		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					...
					<?php 
					if($data_cek['gender']=='Laki-laki'){ 
					?>
						<option value="Laki-laki" selected>Laki-laki</option>
						<option value="Perempuan">Perempuan</option>
					<?php } elseif($data_cek['gender']=='Perempuan'){
						?>
		 ...
		 <div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="nama" name="agama" value="<?php echo $data_cek['agama']; ?>">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="nama" name="email" value="<?php echo $data_cek['email']; ?>">
				</div>
			</div>
			<!-- end -->
